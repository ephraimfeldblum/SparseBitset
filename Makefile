...
CC = gcc
CXX = g++
CFLAGS = -Wall -Wextra -Wpedantic -Wconversion -Wsign-compare -Wpointer-arith -Wno-missing-braces -Wno-missing-field-initializers -Wno-missing-attributes -O3 -fPIC -std=c11 -march=native -mavx512f -mavx512cd -mavx512dq -mavx512bw # -ftime-trace
CXXFLAGS = -Wall -Wextra -Wpedantic -Wconversion -Wsign-compare -Wpointer-arith -Wno-missing-braces -Wno-missing-field-initializers -Wno-missing-attributes -O3 -fPIC -std=c++23 -march=native -mavx512f -mavx512cd -mavx512dq -mavx512bw # -ftime-trace
LDFLAGS = -shared
