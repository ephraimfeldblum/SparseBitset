...
CC = gcc
CXX = g++
CFLAGS = -Wall -Wextra -Wpedantic -Wconversion -Wsign-compare -Wpointer-arith -O3 -fPIC -std=c11 -march=native # -ftime-trace
CXXFLAGS = -Wall -Wextra -Wpedantic -Wconversion -Wsign-compare -Wpointer-arith -O3 -fPIC -std=c++23 -march=native # -ftime-trace
LDFLAGS = -shared
